...
class Missile(pygame.sprite.Sprite):    #미사일
...
class Rock(pygame.sprite.Sprite):   # 운석
    def __init__(self, xpos, ypos, speed):
        super(Rock, self).__init__()
        rock_images = ('rock01.png', 'rock02.png', 'rock03.png', 'rock04.png', 'rock05.png') #,\
                        # 'rock06.png', 'rock7.png', 'rock08.png', 'rock09.png', 'rock10.png', \
...
def game_menu():
    ...
    draw_text('엔터 키 누르면 시작!', font_40, screen, draw_x, draw_y + 200, WHITE)
